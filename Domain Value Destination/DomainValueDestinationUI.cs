...
{
    class DomainValueDestinationUI : IDtsComponentUI
    {
        ...
        {
            frmDomainValueDestinationUI editor = new frmDomainValueDestinationUI(metaData, serviceProvider, variables, connections);
